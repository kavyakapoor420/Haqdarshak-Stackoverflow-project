...
//         {/* Main Heading */}
//         <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">Empowering Welfare Agents with Ai Powered Knowledge</h1>

//         {/* Subheading */}
//         <p className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto mb-12 leading-relaxed">
//            Built for agents, by agents. Our platform combines institutional knowledge with community wisdom to solve real-world welfare scheme challenges.
//         </p>

//         {/* Button with Circle Animation */}
//         <div className="relative mb-16">
//           {/* Animated Circle */}
//           <div className="absolute inset-0 flex items-center justify-center">
//             <div className="w-64 h-64 border-2 border-teal-400 rounded-full animate-pulse opacity-30"></div>
//           </div>
//           <div className="absolute inset-0 flex items-center justify-center">
//             <div className="w-48 h-48 border-2 border-teal-400 rounded-full animate-ping opacity-20"></div>
//           </div>

//           {/* Main Button */}
//           <div className="relative z-10 ">
//             <Link to={'/all-approved-community-posts'}>
//                {/* <button className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold px-8 py-4 rounded-lg text-lg transition-colors duration-200"> */}
...
//         <div className="relative max-w-6xl mx-auto"> {/* Changed from max-w-5xl to max-w-6xl */}
//           {/* Blue Glow Effect */}
...
//                 {/* Main Text */}
//                 <div className="mb-8">
//                   <h2 className="text-3xl md:text-4xl lg:text-5xl text-white font-light mb-2">the cloud native</h2>
//                   <h2 className="text-3xl md:text-4xl lg:text-5xl text-white font-bold mb-4">playground</h2>
//                   <p className="text-gray-300 text-lg md:text-xl">find every CNCF project inside</p>
//                 </div>
